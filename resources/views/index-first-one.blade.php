...
<body style="background-image: url({{ asset('img/background.jpg') }});">
    <div class="container">
        ...
        <section class="card-patient"
            ...
            margin-bottom: 20px;
        ">
            <div class="card-patient__form justify-content-center"
                style="
        ...
        ">
            ...
            font-size: 17px;
        ">
                        Пройдите регистрацию</h6>
                    <label for="medid">Почта</label>
                    <input class="width-input form-control @error('email') is-invalid @enderror" id="email"
                        form='form' type="email" name="email" required autocomplete="email">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                    <label for="medid">Пароль</label>
                    <input class="width-input form-control @error('password') is-invalid @enderror" id="password"
                        form='form' type="password" name="password" required autocomplete="new-password">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                    <label for="codeMKB">Подтвердите пароль</label>
                    <input class="width-input form-control" id="password-confirm" type="password" form='form'
        ...
        <section class="card-patient">
            ...
            <form class="card-patient__form" method="POST" action="{{ route('answers-first-one') }}" id="form">
                @csrf
        ...
        <!-- <section class="card-patient" style="
            display: flex;
            flex-direction: column;
        ">
            <div class="card-patient__form justify-content-center" style="
            justify-content: center;
        ">
                <div class="card-patient__second-column" style="
            display: flex;
            flex-direction: column;
            justify-content: center;
        ">
            ...
            .then(function(response) {
                ...
                if (response.ok) {
                    ...
                    response.json().then(function(data) {
                        alert(`Ваша почта для входа: ${data.email}`);
                    });
